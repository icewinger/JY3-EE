...
public class Item {
     ...
     * @mbggenerated
     */
    public Item(Integer id, Long orderNo, Integer userId, Integer productId, String productName, String productImage, BigDecimal currentUnitPrice, Integer quantity, BigDecimal totalPrice, Date createTime, Date updateTime) {
        this.id = id;
