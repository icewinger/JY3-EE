...
public class ServletResponse<T> {
    ...
    private ServletResponse(Integer status,T data){
        this.status = status;
        this.data = data;
    }
...
@JsonIgnore
    ...
    public static ServletResponse getRequestFailed(String msg,Integer status)
    {
        return  new ServletResponse(StatusCode.FAILED,status,msg);
    }
